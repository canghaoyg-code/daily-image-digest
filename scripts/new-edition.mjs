...
const edition = {schemaVersion:1, id, editionDate:date, status:"draft", headline:"", cutoffAt:cutoff.toISOString(), generatedAt:now.toISOString(), sources:[], stories:[], items:[], newsroom:{version:1, observations:[], candidates:[], topics:[]}, editorialReview:{decision:"revise", reviewedAt:now.toISOString(), imageRelevance:"", voiceDiversity:"", readingOrder:"", coverage:""}};
...
try {
  ...
  console.log(`北京时间 ${date}；已存在当期草稿，继续使用 ${path}`);
}
