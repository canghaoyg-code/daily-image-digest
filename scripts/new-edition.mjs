...
const edition = {schemaVersion:1, id, editionDate:date, status:"draft", headline:"", cutoffAt:cutoff.toISOString(), generatedAt:now.toISOString(), sources:[], stories:[], items:[], editorialReview:{decision:"revise", reviewedAt:now.toISOString(), imageRelevance:"", voiceDiversity:"", readingOrder:"", coverage:""}};
